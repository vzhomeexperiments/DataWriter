...
#property strict
#define EANAME "DataWriter_v6.03"
/*
...
double spread = MarketInfo(symboll,MODE_SPREAD);
               ...
               for(int j = 0; j < barsCollect; j++)    //j scrolls through bars of the day
                 {
                   ...
                   data = string(TIME); 
                     ...
                     ind[2]  = DoubleToStr( spread, digits );
                     ind[3]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j),3);
                     ind[4]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+2),3);
                     ind[5]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+3),3);
                     ind[6]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+5),3);
                     ind[7]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+8),3);
                     ind[8]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+13),3);
                     ind[9]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+21),3);
                     ind[10]  = DoubleToStr(iRSI(symboll,charPer1, 8, PRICE_MEDIAN, j+34),3);
                     ind[12] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j),3);
                     ind[13] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+2),3);
                     ind[14] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+3),3);
                     ind[15] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+5),3);
                     ind[16] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+8),3);
                     ind[17] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+13),3);
                     ind[18] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+21),3);
                     ind[19] = DoubleToStr(iADX(symboll,charPer1, 8,PRICE_MEDIAN, MODE_MAIN,j+34),3);


                     //ATR
                     ind[20] = DoubleToStr(iATR(symboll,charPer1, 8,j),digits);
                     ind[21] = DoubleToStr(iATR(symboll,charPer1, 8,j+2),digits);
                     ind[22] = DoubleToStr(iATR(symboll,charPer1, 8,j+3),digits);
                     ind[23] = DoubleToStr(iATR(symboll,charPer1, 8,j+5),digits);
                     ind[24] = DoubleToStr(iATR(symboll,charPer1, 8,j+8),digits);
                     ind[25] = DoubleToStr(iATR(symboll,charPer1, 8,j+13),digits);
                     ind[26] = DoubleToStr(iATR(symboll,charPer1, 8,j+21),digits);
                     ind[27] = DoubleToStr(iATR(symboll,charPer1, 8,j+34),digits);
